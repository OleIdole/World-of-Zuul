...
public class Room {
    ...
    /**
     * Checks if the input name is a valid name for an item in the room. If
     * there is an item with that name, returns true, if not, false.
     *
     ...
     * west". If there are no exits, returns the description "There are no
     * exits!".
     *
    ...
    /**
     * Sets exit direction from the room, and where you end up by going that
     * direction.
     *
